...
def train(script_args, training_args, train_ds, test_ds):
    ...
    if script_args.mlflow_uri is not None and script_args.mlflow_experiment_name is not None and script_args.mlflow_uri != "" and script_args.mlflow_experiment_name != "":
...
if __name__ == "__main__":
    ...
    # Load datasets
    train_ds = load_from_disk(script_args.train_dataset_path)

    if script_args.test_dataset_path:
        test_ds = load_from_disk(script_args.test_dataset_path)
    else:
        test_ds = None
