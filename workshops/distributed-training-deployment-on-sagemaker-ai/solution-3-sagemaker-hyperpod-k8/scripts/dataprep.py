...
def read_dataset(dataset_name):
    dataset = load_dataset(dataset_name, data_files={'train': ['json-mode-agentic.json']})
...
if __name__ == "__main__":
    ...
    train['text'] = train['conversations'].apply(lambda x: tokenizer.apply_chat_template(x, tokenize=False))
    test['text'] = test['conversations'].apply(lambda x: tokenizer.apply_chat_template(x, tokenize=False))
