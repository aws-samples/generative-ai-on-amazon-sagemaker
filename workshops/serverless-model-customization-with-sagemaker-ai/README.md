...
| 2b   | `2b-import-model-from-s3.ipynb` | _(Alternative to step 2)_ Skip training — import a pre-trained model from S3 and register it as a Model Package            |
...
| 2b   | `2b-dpo-import-model-from-s3.ipynb` | _(Alternative to step 2)_ Skip training — import a pre-trained model from S3 and register it as a Model Package          |
...
| 3b   | `3b-import-model-from-s3.ipynb`             | _(Alternative to step 3)_ Skip training — import a pre-trained model from S3 and register it as a Model Package |
