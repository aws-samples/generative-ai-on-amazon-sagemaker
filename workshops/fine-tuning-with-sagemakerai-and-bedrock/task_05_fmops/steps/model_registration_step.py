...
#                 name=model_name,
#                 source=model_artifacts_s3_path,  # Direct S3 path to model artifacts
#                 run_id=run_id,
...
#                 )
#                 print(f"Model {model_name} version {model_version.version} added to Staging due to lower evaluation score")
...
#             try:
#                 # Register model using mlflow API (simpler approach)
#                 model_details = mlflow.register_model(
#                     model_uri=f"runs:/{run_id}/model",
#                     name=model_name,
#                     tags=tags
#                 )
#                 latest_version = model_details.version
#                 print(f"Alternative registration successful: {model_name} version {latest_version}")
#             except Exception as e2:
#                 print(f"Alternative registration failed: {str(e2)}")
#                 latest_version = "unknown"
                
#         # Create SageMaker integration for the model
#         try:
...
#     return model_name, latest_version
